...
default['awesome_customers']['enabled_firewall_rules'] = %w(firewall_httpd firewall_sshd)
...
default['awesome_customers']['database']['seed_file'] = '/root/chef-repo/chef-repo/cookbooks/awesome_customers/files/default/create-tables.sql'
